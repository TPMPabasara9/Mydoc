...
import { specialityData } from "../assets/assets/assets/assets_frontend/assets.js";
...
const SpecialityMenu = () => {
  return (
    <div className="flex flex-col items-center gap-4 py-16 text-gray-800 " id="speciality" >
        ...
        <p className="sm:w-1/3 text-center text-sm">Browse through our extenisve list of trusted doctors, schedule your appointment hassle-free.</p>

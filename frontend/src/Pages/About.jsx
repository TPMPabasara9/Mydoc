...
const About = () => {
  return (
      ...
      <div className='my-10 flex flex-col sm:flex-row gap-4'>
        ...
        <div className='flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600'>
          <p>Welcome to Prescripto, your trusted partner in managing your healthcare needs conveniently and efficiently.
            At Prescripto,
            we understand the challenges individuals face when it comes to scheduling
    ...
    <div className='flex flex-col md:flex-row gap-4 mb-20'>
      <div className='border px-10 md:px-16 py-8 sm:py-16 flex-col gap-5 text-[15px] hover:bg-indigo-500 hover:text-white transition-colors duration-300'>
        <b> Efficiency:</b>

  ...
  return dashData && (
    <div className='m-5'>
      <div className='flex flex-wrap gap-3'>
        <div className='flex item-center gap-2 bg-white p-4 rounded-border-2 border-gray-100 cursor-pointer hover:scale-10 transition-all'>
            ...
            dashData.latestappointments.map((item,index)=>(
              <div className='flex items-center px-6 py-3 gap-3 hover:bg-gray-100' key={index}>
                ...
                </div>
                {
                  ...
                  :<img onClick={()=>cancelAppointment(item._id)} className='w-5 cursor-pointer' src={assets.cancel_icon} alt="Cancel" /> 
